...
- **Style from image** — give it a picture. Reads line vs paint / saturation / contrast first, then plans a lead + mixer + accent. NovelAI PNG metadata or Danbooru IQDB wins over guesses. Visual picks ignore subject color (nax V4.5 previews all show the same orange hoodie). Not a citation.
